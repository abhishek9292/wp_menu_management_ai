...
class WPMMAI_Base_Lib {
    ...
    public static function get_instance($options_id = '') {
        if (self::$instance===null) {        
            self::$instance = new WPMMAI_Base_Lib($options_id);
        }
    ...
    public function get_option($option_name, $default = false) {
        ...
        $value = apply_filters('wpmmai_get_option_'. $option_name, $value);
    ...
    /**
     * Delete WPMMAI option with name option_name
